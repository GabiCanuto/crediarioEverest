...
export default function App() {
  ...
  const stores = [
    ...
    { name: "Visite nosso site", url: "https://www.lojaseverest.com.br/?srsltid=AfmBOooZ147u1xEEcIlOYnGB1QHugsdgs9kJpHPFwHWc4w3N_VahA_9_" },
  ];
    ...
    <>
      ...
      >
        <section className="card" aria-live="polite" ref={cardRef}>
          <h1 className="headline">Seja bem-vindo ao Crediário Everest.</h1>
          <p className="sub">Aqui você pode comprar direto com a loja de sua preferência. 
Basta clicar no botão abaixo e você será atendido via WhatsApp</p>
